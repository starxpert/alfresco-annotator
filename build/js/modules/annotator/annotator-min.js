...
(function() {
  ...
  Annotator = (function(_super) {
        ...
        load: (function(_this) {
          return function(field, annotation) {
            if (annotation.text) {
              ...
              $(field).html("<i>" + (_t(Alfresco.util.message("No.Comment",this.name))) + "</i>");
            }
    ...
    Annotator.prototype._setupEditor = function() {
      ...
      this.editor.hide().on('hide', this.onEditorHide).on('save', this.onEditorSubmit).addField({
        type: 'textarea',
        label: _t(Alfresco.util.message("Comments.label",this.name)) + '\u2026',
  ...
  Annotator.Editor = (function(_super) {
    ...
    Editor.prototype.html = "<div class=\"annotator-outer annotator-editor\">\n  <form class=\"annotator-widget\">\n    <ul class=\"annotator-listing\"></ul>\n    <div class=\"annotator-controls\">\n      <a href=\"#cancel\" class=\"annotator-cancel\">" + _t(Alfresco.util.message("Cancel.label",this.name)) + "</a>\n<a href=\"#save\" class=\"annotator-save annotator-focus\">" + _t(Alfresco.util.message("Save.label",this.name)) + "</a>\n    </div>\n  </form>\n</div>";
  ...
  Annotator.Viewer = (function(_super) {
    ...
    Viewer.prototype.html = {
      ...
      item: "<li class=\"annotator-annotation annotator-item\">\n  <span class=\"annotator-controls\">\n    <a href=\"#\" title=\"View as webpage\" class=\"annotator-link\">View as webpage</a>\n    <button title=\""+Alfresco.util.message("Edit.label",this.name)+"\" class=\"annotator-edit\">"+Alfresco.util.message("Edit.label",this.name)+"</button>\n    <button title=\""+Alfresco.util.message("deletee.label",this.name)+"\" class=\"annotator-delete\">"+Alfresco.util.message("deletee.label",this.name)+"</button>\n  </span>\n</li>"
    };
